...
import { sampleAuthoredTerrainInfluence } from "./world-semantics.mjs";
...
function applyFrontierBasinShaping(worldX, worldZ, height, seed) {
  ...
  const semanticTerrain = sampleAuthoredTerrainInfluence(worldX, worldZ);
  ...
  shaped -= semanticTerrain.riverbedCutMeters;
  shaped -= semanticTerrain.roadCutMeters;
  shaped = mixHeight(shaped, shaped - semanticTerrain.bankTerraceMeters, semanticTerrain.waterBank * 0.35);
