...
export const generationGraphPath = "generation/graph.json";
export const generationGraphFormat = "open-fps-world-generation-graph-v1";
export const generationGraphVersion = 1;
...
export const worldObjectsPath = "objects/manifest.json";
export const worldObjectCellsDirectory = "objects/cells";
export const worldObjectManifestVersion = 1;
export const worldObjectManifestFormat = "world-object-manifest-v1";
export const worldObjectCellFormat = "world-object-cell-pack-v1";
export const cookedMapsDirectory = "cooked/maps";
export const cookedMapManifestFile = "manifest.json";
export const cookedMapFormat = "open-fps-cooked-map-v4";
export const cookedMapVersion = 4;
...
export const cookedObjectCellFormat = worldObjectCellFormat;
