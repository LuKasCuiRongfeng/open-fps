...
export function createSemanticArchetypes(assetRegistry) {
  ...
  return {
    "road-dirt-segment": {
      ...
      render: { kind: "ribbon", ribbonMaterial: "road", decalMaterial: "road-ruts", edgeBlendMeters: 4, targetSegmentsPerMeter: 0.12 },
      ...
      budget: { lodGroup: "road-ribbon", maxVisibleDistanceMeters: 850, maxDrawCallsPerCell: 2 },
    ...
    "road-rocky-segment": {
      ...
      navCost: 0.65,
      clearsVegetation: true,
      render: { kind: "ribbon", ribbonMaterial: "road", decalMaterial: "rocky-road-ruts", edgeBlendMeters: 3, targetSegmentsPerMeter: 0.1 },
      ...
      budget: { lodGroup: "road-ribbon", maxVisibleDistanceMeters: 760, maxDrawCallsPerCell: 2 },
    ...
    "road-forest-path": {
      ...
      navCost: 0.55,
      clearsVegetation: true,
      render: { kind: "ribbon", ribbonMaterial: "forest-path", decalMaterial: "trampled-grass", edgeBlendMeters: 5, targetSegmentsPerMeter: 0.1 },
      editor: { icon: "route", color: "#7f9863", placement: "spline", defaultRadiusMeters: 5 },
      scatter: { mode: "path", minSpacingMeters: 10, alignToTerrain: true, avoidLayers: ["water"] },
      budget: { lodGroup: "road-ribbon", maxVisibleDistanceMeters: 620, maxDrawCallsPerCell: 2 },
    ...
    "river-segment": {
      ...
      navCost: 3.5,
      clearsVegetation: true,
      render: { kind: "ribbon", ribbonMaterial: "water", surfaceMaterial: "river-water", bankWetnessMeters: 10, targetSegmentsPerMeter: 0.16 },
      ...
      budget: { lodGroup: "water-ribbon", maxVisibleDistanceMeters: 920, maxDrawCallsPerCell: 2 },
    ...
    "stream-segment": {
      ...
      navCost: 2.5,
      clearsVegetation: true,
      render: { kind: "ribbon", ribbonMaterial: "water", surfaceMaterial: "stream-water", bankWetnessMeters: 6, targetSegmentsPerMeter: 0.14 },
      ...
      budget: { lodGroup: "water-ribbon", maxVisibleDistanceMeters: 680, maxDrawCallsPerCell: 2 },
      validation: { requiresTerrain: true, maxSlopeDegrees: 18, clearsVegetation: true },
    },
    camp: {
      layer: "poi",
      ...
      budget: { lodGroup: "poi-prefab", instanceMode: "batched-gltf", maxInstancesPerCell: 8 },
      prefab: [
    ...
    "lookout-tower": {
      ...
      budget: { lodGroup: "poi-landmark", instanceMode: "unique-gltf", maxInstancesPerCell: 2 },
    ...
    "broken-bridge": {
      ...
      budget: { lodGroup: "poi-structure", instanceMode: "batched-gltf", maxInstancesPerCell: 3 },
    ...
    "abandoned-homestead": {
      ...
      budget: { lodGroup: "poi-structure", instanceMode: "batched-gltf", maxInstancesPerCell: 4 },
      prefab: [
    ...
    "forest-clearing": {
      ...
      budget: { lodGroup: "scatter-rocks", instanceMode: "instanced-gltf", maxInstancesPerCell: 32 },
      validation: { requiresTerrain: true, maxSlopeDegrees: 18, clearsVegetation: true },
    },
    "road-sign": {
      layer: "prop",
      ...
      budget: { lodGroup: "small-props", instanceMode: "instanced-gltf", maxInstancesPerCell: 24 },
    ...
    "split-rail-fence": {
      ...
      budget: { lodGroup: "fence-spline", instanceMode: "instanced-gltf", maxInstancesPerCell: 48 },
    ...
    "supply-crates": {
      ...
      budget: { lodGroup: "small-props", instanceMode: "instanced-gltf", maxInstancesPerCell: 40 },
    ...
    "bridge-debris": {
      ...
      budget: { lodGroup: "small-props", instanceMode: "instanced-gltf", maxInstancesPerCell: 36 },
      validation: { requiresTerrain: true, maxSlopeDegrees: 18, blocksNav: true },
    },
  };
}
