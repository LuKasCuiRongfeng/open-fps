...
- `MapData.ts`: map schema, manifest helpers, binary height page helpers, and map versioning
...
- Store editable terrain height payloads as sparse virtual height pages listed by page keys in the map manifest.
